...
module.exports = {
  content: ["./index.html", "./admin.html", "./admin-messages.html", "./app.js", "./session-ui.js", "./gallery.js", "./admin.js", "./admin-ui.js", "./admin-app.js", "./popup-announcement.js", "./chat.js", "./drive-sync.js", "./face-search.js", "./face-index.js"],
  theme: { extend: {} },
  plugins: []
};
